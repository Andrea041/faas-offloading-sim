...
class Agent():
    ...
    def _build_model(self):
        ...
        action = layers.Dense(self.action_size, activation="softmax")(common)
    ...
    def act(self, state, action_filter):
        ...
        while 1:
            ...
            if action in allowed_actions:
                return action, np.squeeze(critic_value)
...
class Actor_Critic(Policy):
    ...
    def schedule(self, e):
        ...
        # scegli un'azione tra quelle possibili
        action, critic_value = self.agent.act(np_state,action_filter)
